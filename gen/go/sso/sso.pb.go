...
type AssignPermissionRequest struct {
	...
	AppId      int32 `protobuf:"varint,3,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"`    // App ID for assinging permission.
	Permission int32 `protobuf:"varint,2,opt,name=permission,proto3" json:"permission,omitempty"`       // Permission that should be assigned.
}
...
type RemovePermissionRequest struct {
	...
	AppId      int32 `protobuf:"varint,3,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"`    // App ID for removing permission.
	Permission int32 `protobuf:"varint,2,opt,name=permission,proto3" json:"permission,omitempty"`       // Permission that should be removed.
}
